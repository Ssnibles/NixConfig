...
├── hosts/
│   ├── shared.nix                  | common hardware/bootstrap settings shared by all hosts
│   ├── desktop/
│   │   ├── configuration.nix        | desktop host overrides (nvidia, packages, ports)
...
│   └── laptop/
│       ├── configuration.nix        | laptop host overrides (tlp, tpm, realtek wifi)
