...
ls.add_snippets("typst", {
	...
	---------------------------------------------------------------------------
	s({ trig = "page", desc = "Clean notes page boilerplate with dynamic theme and running headers" }, {
		t({ '#let theme = "' }),
		c(1, {
			sn(nil, { t("dark") }),
			sn(nil, { t("light") }),
		...
		t({ "// Level 1: Large italic title", "" }),
		t({ "#show heading.where(level: 1): it => block(above: 1.8em, below: 1.2em)[", "" }),
		...
		t({ "  ])", "" }),
		t({ "]", "", "" }),
		t({ "// Level 3: Bold italic subsection title", "" }),
		t({ "#show heading.where(level: 3): it => block(above: 1.4em, below: 0.8em)[", "" }),
