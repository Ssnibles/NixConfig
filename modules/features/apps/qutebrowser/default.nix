# =============================================================================
# Qutebrowser Keyboard-Focused Web Browser Feature
# =============================================================================
# Qutebrowser configuration script, QtWebEngine performance tweaks, custom
# searchengines/quickmarks, dark mode colors from theme palette, and keybindings.
# =============================================================================
{ ... }:
{
  nixos.modules.shared =
    ...
    in
    {
      options.features.qutebrowser.enable = lib.mkOption {
        type = lib.types.bool;
        default = false;
        description = "Enable Qutebrowser web browser module.";
      };
          ...
          files = {
            ".config/qutebrowser/config.py" = {
              text = ''
                ...
                c.content.blocking.method = "adblock" # Use the faster Rust/Brave adblock engine
                c.content.cookies.accept = "all"
                c.content.prefers_reduced_motion = True

                # Process & Memory Optimisations for QtWebEngine
                c.qt.args = [
                    "enable-gpu-rasterization",
                    "enable-accelerated-video-decode",
                    "renderer-process-limit=6",       # Restrict max worker processes so 10+ tabs share memory
                    "enable-features=IsolateOrigins,site-per-process",
                    "enable-low-end-device-mode",     # Aggressively frees memory on background tabs
                ]
                ...
                # Useful tab unloading shortcut for tab hoarders
                config.bind(",u", "tab-give") # Unloads active tab from RAM until clicked
